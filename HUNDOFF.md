...
| 官方/行业全景 | 63 |
| 最近原始抓取 | 176 |
| 当时已配置通道 | 42；本轮扩展后为 58 个查询 |
| 最近一次成功通道 | 42 |
| 失败通道 | 0 |

数据生成时间：`2026-07-27T02:54:07.888Z`。本轮上线后应手动触发一次工作流，让 58 个查询、全文状态和新技术标签进入生产数据。
...
- 本轮周报 PDF 实际下载为 A4 9 页；修改后必须继续通过 Poppler PNG 渲染检查，确认无裁切、重叠或乱码。
