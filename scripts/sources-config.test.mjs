...
test("domestic industry and academic channels are configured without duplicate ids", () => {
  ...
  for (const requiredId of [
    ...
    "news-ai-cn-platform-llm",
    "news-ai-cn-oem",
    "news-ai-global-oem",
    "news-ai-edge-diagnosis",
    "research-ai-fault-domain",
    "research-ai-rul-digital-twin",
    "research-ai-physics-edge",
    "research-ai-design-loads",
    "research-ai-oil-acoustic",
    "research-ai-llm-platform",
    "research-ai-cn",
