...
首页按三个内容栏目组织：默认进入“风电传动链专栏”，另有“风电行业全景”和“企业与项目追踪”，并保留“全部”。论文、官方发布、企业新闻属于来源类型，同一资料可以进入多个内容栏目，但资料库和周报只保留一次。用户还可以按地区、资料类型、时间、可靠度或个人偏好排序。

传动链专栏进一步按八个技术主体和细分标签组织：系统与架构、齿轮与行星传动、轴承与连接、材料与制造工艺、失效与质量、润滑与摩擦、仿真与数字工程、监测诊断与试验。细分范围包括感应淬火、喷丸、磨齿/珩齿、轴承跑圈、滑动轴承、齿轮箱振动/NVH、AVL EXCITE、Romax、MASTA、KISSsoft、行星架强度、箱体变形、装配不对中等。
...
最近一次生产数据采集时间为 `2026-07-27T07:27:32.480Z`。本轮 58/58 个采集通道全部成功，全文提取状态、新技术标签和 103 条当前窗口资料均已写入生产数据；后续由周一自动任务继续更新。
