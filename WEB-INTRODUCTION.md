...
这份 PDF 不是网页截图，也不是文章全文汇编，而是对最近 7 天已进入资料库的情报重新组织后的结构化摘要。每条情报固定展示：

- 主体：谁或哪个机构/企业/论文团队
- 做了什么：项目、政策、交付、研究目标或技术方法
- 效果/进展：公开资料已经披露的结果、进展或核验状态
- 必要数据：容量、金额、时间、指标、对比和工况等；没有公开数据时明确写“未披露”
- 工程意义：对设计、验证、运维或供应链的影响和边界
- 原文：发布方、DOI 或原始链接
